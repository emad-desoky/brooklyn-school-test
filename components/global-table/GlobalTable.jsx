...
const GlobalTable = ({ rankings }) => {
  ...
  const uniqueCountries = [
    ...new Set(rankings.map((ranking) => ranking.countryOrTerritory)),
  ];
  const uniqueRegions = [...new Set(rankings.map((ranking) => ranking.region))];
            ...
            {uniqueCountries.map((country) => (
              ...
              >
                <input
                  ...
                  checked={selectedFilters.countryOrTerritory.includes(country)}
                  onChange={() =>
            ...
            {currentRankings.map((ranking) => (
              <tr
                ...
                className={`hover:bg-gray-100 ${
                  ranking.rank2025 <= 10 ? "bg-green-50" : "bg-white"
                }`}
              >
